...
destroy:function(){var a,c;if(this.is("initialised")){if(this.editor&&this.editor.is("loaded")){a=$(this.options.textarea);c=a.val();try{this.c()}catch(b){refinery.log(b)}this.editor=null;a.val(c)}this.holder.find(".wysiwyg-editor-holder").remove();this.b.remove()}this._destroy();return this},d:function(){function a(){var a;b.addClass("wysiwyg-editor-on");f.remove(d.file.name);f.load();a=$(f.getElement("wrapper")).find("#epiceditor-utilbar");c.f(a);c.h(a);c.g(a)}var c=this,b=c.holder,e=b.find("textarea"),
d=c.options,f;d.textarea=e.get(0);c.editor=f=new EpicEditor(d);c.b.on("click",function(h){var g=e.val();h.preventDefault();b.hasClass("wysiwyg-editor-on")?(c.c(),e.val(g)):(a(),f.importFile(d.file.name,g))});a()},init:function(a){var c;this.is("initialisable")&&(this.is("initialising",!0),this.attach_holder(a),c=$("<div/>",{"class":"wysiwyg-editor-holder"}).appendTo(a),this.options.container=c.get(0),this.options.file.name="refinery"+this.uid,this.b=$("<button/>",{"class":"epiceditor-toggle-button",
text:t("refinery.editor.toggle_editor")}).appendTo(a),this.d(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});refinery.admin.ui.editorEpicEditor=function(a){var c=a.find(".ui-tabs"),b=[];a.find(".wysiwyg-editor-wrapper").each(function(){b[b.length]=refinery("editor.EpicEditor").init($(this))});c.on("tabsactivate",function(){for(var a=b.length-1;0<=a;a--)b[a].editor&&b[a].editor.reflow()})};}(window, jQuery));
