...
a.stopPropagation();b.init().open();return!1});b.on("insert",function(a){var b="![%alt](%url)";a.url?(b=b.replace("%alt",a.alt),b=b.replace("%url",a.url),c.insert(b)):c.f(a.id)});c.a=b},f:function(c){var a=this,b;b=refinery("admin.ImageDialog",{image_id:c,buttons:[{text:"Insert",click:function(){b.insert()}},{text:"Back to the library",click:function(){b.close();a.a.open()}}]}).init();b.on("insert",function(d){var c;c="![%alt](%url)".replace("%alt",d.alt);c=c.replace("%url",d.sizes[d.size]);a.insert(c);
b.destroy(!0)});b.open()},i:function(){var c=this,a=c.b,b,a=$("<button/>",{title:t("refinery.editor.resources_dialog_button_title"),"class":"editor-resources-dialog-btn refinery-btn"}).prependTo(a);b=refinery("admin.ResourcesDialog");a.on("click",function(a){a.preventDefault();a.stopPropagation();b.init().open();return!1});b.on("insert",function(a){c.insert('<a href="'+a.url+'" class="file '+a.ext+'" title="'+a.name+" - "+a.size+' bytes " >'+a.name+"</a>")});c.c=b},h:function(){var c=this,a=c.b,b,
